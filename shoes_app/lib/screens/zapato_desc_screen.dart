...
class ZapatoDescScreen extends StatelessWidget {
  static const String routerName = 'zapato-desc';
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Stack(
              children: const [
                Positioned ( left: 90,child: _BotonColor( Color(0xffC6D642), 4, 'assets/verde.png' )),
                Positioned ( left: 60,child: _BotonColor( Color(0xffFFAD29), 3, 'assets/amarillo.png' )),
                Positioned ( left: 30,child: _BotonColor( Color(0xff2099F1), 2, 'assets/azul.png' )),
  ...
  Widget build(BuildContext context) {
    return FadeInLeft(
      ...
      child: GestureDetector(
        onTap: () {
          final zapatoModel = Provider.of<ZapatoProvider>(context, listen: false);
